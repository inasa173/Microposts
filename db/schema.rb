...
ActiveRecord::Schema.define(version: 20170614042632) do
  ...
  create_table "favorits", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["micropost_id"], name: "index_favorits_on_micropost_id", using: :btree
    t.index ["user_id", "micropost_id"], name: "index_favorits_on_user_id_and_micropost_id", unique: true, using: :btree
    t.index ["user_id"], name: "index_favorits_on_user_id", using: :btree
  end
  ...
  add_foreign_key "favorits", "microposts"
